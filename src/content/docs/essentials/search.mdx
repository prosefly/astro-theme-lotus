---
title: Search
description: Use the built-in search dialog and generated search index.
sidebar:
  order: 6
---

Lotus includes a client-side search dialog and a generated JSON index. The
integration injects the search route beside the docs routes.
