...
3. **Rebuild docs navigation in `theme.config.ts`.**
...
[Docs Navigation](/docs/configuration/sidebars/) for navigation structure.
...
[Docs Navigation](/docs/configuration/sidebars/), and
