...
3. **Rebuild docs navigation in `theme.config.json`.**

   Lotus owns sidebar structure from `themeConfig.docsNav`. Use string items,
...
[Docs Navigation](/docs/configuration/docs-nav/) for navigation structure.
...
content, routes, frontmatter intent, docs navigation, i18n structure, search behavior,
...
4. Move Starlight site, sidebar, social, edit link, i18n, search, and appearance
   ...
   the lotus({...}) options in astro.config.ts.
...
7. Convert Starlight sidebar autogeneration to Lotus docsNav[].items entries
...
[Docs Navigation](/docs/configuration/docs-nav/), and
