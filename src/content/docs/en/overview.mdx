...
<CardGrid>
  ...
  <Card icon="lucide:route" title="Routing" href="/docs/configuration/content-routing/">
    ...
    and optional homepage routes from Astro content collection entries.
  </Card>
...
[Internationalization](/docs/configuration/i18n/). For loader base, homepage,
...
1. **Install the theme.**
   ...
   Add Lotus and the shared components package, then register the integration
   in `astro.config.ts`.
...
2. **Configure routes and locales.**
   ...
   Decide where docs are mounted, whether the site needs a homepage, and how
   localized content directories map to public URLs.
