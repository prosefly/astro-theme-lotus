...
| `PageMeta` | Contributors and edit link between docs content and previous/next navigation. | `contributors`, `editUrl`, `title`, `pageUrl`, `markdownUrl`, `currentSlug`, `currentLocale` |
...
| `PageMeta` | `PageMeta`, `EditThisPage`, `Contributors` |
...
| `PageMeta`, `EditThisPage`, `Contributors` | Reusing the docs page meta area or its smaller parts. |
