...
export const description = 'Lotus is an Astro documentation theme with configurable navigation, docs navigation, appearance tokens, MDX components, and Expressive Code integration.'
```
````
