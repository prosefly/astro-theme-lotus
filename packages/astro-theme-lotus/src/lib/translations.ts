...
const englishTranslations = {
  ...
  'pageContributors.commits.one': '{{count}} commit',
  'pageContributors.commits.other': '{{count}} commits',
  'pageContributors.title': 'Contributors',
...
const builtInTranslations: Record<string, Partial<UiTranslations>> = {
  ...
  'zh-cn': {
    ...
    'page.editLink': '编辑此页',
    'pageContributors.commits.one': '{{count}} 次提交',
    'pageContributors.commits.other': '{{count}} 次提交',
    'pageContributors.title': '贡献者',
